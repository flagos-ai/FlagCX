...
// One-sided callers need to distinguish temporary send-queue pressure from a
// terminal verbs failure. Keep the legacy wrapper above unchanged for
// two-sided transports, where callers historically treat every post failure
// as flagcxSystemError.
static inline flagcxResult_t
