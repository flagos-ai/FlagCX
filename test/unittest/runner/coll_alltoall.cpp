...
// Each rank fills sendbuff so that chunk i contains data identifying the sender.
// After AlltoAll, each rank verifies it received the correct data from each peer.
