...
// These are defined in libflagcx.so — we reference them via linking
extern char flagcxIbIfName[];
extern union flagcxSocketAddress flagcxIbIfAddr;
extern int flagcxNMergedIbDevs;
extern int flagcxNIbDevs;
extern struct flagcxIbMergedDev flagcxIbMergedDevs[];
extern struct flagcxIbDev flagcxIbDevs[];
...
// FLAGCX_PARAM functions — already defined in libflagcx.so
extern int64_t flagcxParamIbGidIndex();
extern int64_t flagcxParamIbRoceVersionNum();
extern int64_t flagcxParamIbTimeout();
extern int64_t flagcxParamIbRetryCnt();
extern int64_t flagcxParamIbPkey();
extern int64_t flagcxParamIbUseInline();
extern int64_t flagcxParamIbSl();
extern int64_t flagcxParamIbTc();
extern int64_t flagcxParamIbArThreshold();
extern int64_t flagcxParamIbPciRelaxedOrdering();
extern int64_t flagcxParamIbAdaptiveRouting();
extern int64_t flagcxParamIbDisable();
extern int64_t flagcxParamIbMergeVfs();
extern int64_t flagcxParamIbMergeNics();
extern int64_t flagcxParamIbQpsPerConn();
extern int64_t flagcxParamIbGdrFlushDisable();
extern int64_t flagcxParamIbSplitDataOnQps();

// flagcxIbAsyncThreadMain is defined in libflagcx.so
extern void *flagcxIbAsyncThreadMain(void *args);

// Begin anonymous namespace to avoid symbol conflicts with libflagcx.so
namespace {

// Helper functions below are already defined in libflagcx.so
// (declared as extern in ib_common.h) — resolved via linking.
...
// reqTypeStr is defined in libflagcx.so
...
// flagcxParamIbGdrFlushDisable is defined in libflagcx.so
...
// flagcxIbFreeRequest is defined in libflagcx.so
...
// flagcxParamIbSplitDataOnQps is defined in libflagcx.so
...
// flagcxIbGdrSupport, flagcxIbDmaBufSupport, flagcxIbDevices
// are defined in libflagcx.so
...
__attribute__((visibility(
    ...
    // Basic functions
    "IBPlugin", flagcxIbInit, flagcxIbDevices, flagcxIbGetProperties,
    NULL, // reduceSupport
    NULL, // getDeviceMr
    NULL, // irecvConsumed
